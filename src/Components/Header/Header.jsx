...
const Header = () => {
  ...
  return (
    <div className="bg-white border-b-2 border-gray-300 sticky top-0 z-50 transition-shadow">
      <div className="w-11/12 md:w-10/11 lg:w-9/12 mx-auto py-2">
        <div className="navbar">
          ...
          <div className="navbar-end">
            <Link
              to="/login"
              className="btn bg-blue-500 hover:bg-blue-600 border-none shadow-none"
            >
              Log in
            </Link>
          </div>
